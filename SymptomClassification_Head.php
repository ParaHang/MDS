...
$cc=calculation("migrane", $output_array, $symptom,$part);
$fl=calculation("meningitis", $output_array, $symptom,$part);

   if($cc > $fl)
   {
   	mysqli_query($con,"INSERT INTO `patient_info`(`patient_id`, `prob_area`, `selected_symptoms`, `diagnosed_disease`, `confi_per`, `drug_pres`) VALUES ($patient,'$part','all','migrane','$cc','')");
   	  $disea='migrane';
   	   $_SESSION['disease_diag']=$disea;
   }
   else {
   mysqli_query($con,"INSERT INTO `patient_info`(`patient_id`, `prob_area`, `selected_symptoms`, `diagnosed_disease`, `confi_per`, `drug_pres`) VALUES ($patient,'$part','all','meningitis','$fl','')");
     $disea='meningitis';
      $_SESSION['disease_diag']=$disea;
   }
