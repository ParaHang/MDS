...
$cc=calculation("Anemia", $output_array, $symptom,$part);
$fl=calculation("leukemia", $output_array, $symptom,$part);

   if($cc > $fl )
   {
   	mysqli_query($con,"INSERT INTO `patient_info`(`patient_id`, `prob_area`, `selected_symptoms`, `diagnosed_disease`, `confi_per`, `drug_pres`) VALUES ($patient,'$part','all','Anemia','$cc','')");
   	  $disea='Anemia';
   	   $_SESSION['disease_diag']=$disea;
   }
   else if ($fl > $cc ){
   mysqli_query($con,"INSERT INTO `patient_info`(`patient_id`, `prob_area`, `selected_symptoms`, `diagnosed_disease`, `confi_per`, `drug_pres`) VALUES ($patient,'$part','all','leukemia','$fl','')");
     $disea='leukemia';
      $_SESSION['disease_diag']=$disea;
   }
